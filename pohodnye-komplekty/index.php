...
$aux_css_url = url_for(WWW_CSS . '/set.css');
...
?>
    ...
    <div class="set-item card">
        ...
        <div class="">
            ...
            <ul class="price">
                <li><p>первые двое суток: 10 120 ₽</p></li>
                <li><p>последующие сутки: 1 680 ₽/сут.</p></li>
    ...
    <div class="set-item card">
        ...
        <div class="">
            ...
            <ul class="price">
                <li><p>первые двое суток: 4 460 ₽</p></li>
                <li><p>последующие сутки: 740 ₽/сут.</p></li>
                <li><p>залог: 15 000 ₽ без <a href="<?php echo WWW_ROOT . '/usloviya-prokata/?question=deposit'; ?>">документа</a> / 1 500 ₽ с <a href="<?php echo WWW_ROOT . '/usloviya-prokata/?question=deposit'; ?>">документом</a></p></li>
            </ul>
        </div>
    ...
    <div class="set-item card">
        ...
        <div class="">
            ...
            <ul class="price">
                <li><p>первые двое суток:  3 200 ₽</p></li>
                <li><p>последующие сутки:  530 ₽/сут.</p></li>
