<?php
require_once(PROJECT_PATH . '/vk-reviews.php');
	...
	<div id="slider">
		...
		<nav id="header-nav" aria-label="header-nav">
			<ul id="menu-top">
				...
				<li><a href="https://vk.com/topic-53310491_28269369" target="_blank" >Отзывы</a></li>
				<li><a href="<?php echo WWW_ROOT . '/contacts/'; ?>">Контакты</a></li>
			</ul>
			<!--a class="header-link contacts" href="<?php echo WWW_ROOT . '/contacts/#contacts_dybenko'; ?>">Кудрово <?php echo CONTACTS_PHONE_KUDROVO; ?></a-->
		</nav>
		<a id="quotes-link" href="https://vk.com/topic-53310491_28269369" rel="nofollow" target="_blank">
		<div id="quotes">
