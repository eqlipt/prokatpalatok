...
<section id="center">
    <article>
        ...
        <div class="card text-block padding-block" id="zalog">
            ...
            <div>
                <p>Арендовать всегда значительно дешевле, нежели покупать. Особенно, если вы собираетесь воспользоваться снаряжением всего пару раз в сезон. Экономится место под хранение снаряжения. Не нужно после каждого похода чистить и стирать снаряжение, а в случае поломок — ремонтировать или искать мастерскую.</p>
            </div>
        </div>
        <div class="card text-block padding-block">
            <div>
