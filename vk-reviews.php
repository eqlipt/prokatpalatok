...
function get_comments_count() {
	...
	$result = json_decode(file_get_contents('https://api.vk.ru/method/board.getTopics?' . $get_params));
...
function get_random_comment() {
	...
	$get_params = http_build_query($request_params);
	$result = json_decode(file_get_contents('https://api.vk.ru/method/board.getComments?' . $get_params));
