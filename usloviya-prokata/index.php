    ...
    <article>
        ...
        <div id="section_zalog" class="card text-block padding-block accordion-item">
            ...
            <div class="accordion-text">
                ...
                <p>Прокат палаток оставляет за собой право не принять документы в качестве залога и отказать в прокате.</p>
            </div>
        </div>
        <div id="section_bronirovanie" class="card text-block padding-block accordion-item">
            ...
            <div class="accordion-text">
                ...
                <p>Предоплату можно осуществить непосредственно в пункте проката, либо переводом. Осуществляя предоплату бронирования переводом, в сообщении (SMS, Whatsapp, Telegram или e-mail) укажите номер заказа или Ваши контакты, даты проката и наименование снаряжения, бронирование которого осуществляете. Либо отправьте нам в мессенджер квитанцию об оплате.</p>
            </div>
        </div>
        <div class="card text-block padding-block accordion-item">
            ...
            <div class="accordion-text">
                <p>Если вы обнаружили повреждения или недочёты на снаряжении, сделайте фото или видео и отправьте нам в любой мессенджер. Это исключит претензии в Ваш адрес при возврате.</p>
